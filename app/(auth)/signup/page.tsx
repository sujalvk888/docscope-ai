      ...
      <div className="relative flex w-full lg:w-1/2 flex-col items-center justify-center p-8 sm:p-12">
        ...
        <div className="w-full max-w-[400px] animate-in fade-in zoom-in-[0.98] slide-in-from-bottom-8 duration-700 ease-out">
          <div className="space-y-2 mb-10">
            <h2 className="text-3xl font-extrabold text-[#1A1515] tracking-tight">Create an account</h2>
            <p className="text-[#73615A] text-base font-medium">Start transforming your documents today.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <Button 
              className="w-full text-lg py-7 rounded-xl mt-4 bg-[#DB6E4C] hover:bg-[#C25A3A] text-[#F5F2E8] shadow-xl shadow-[#DB6E4C]/20 font-bold transition-transform active:scale-[0.98]" 
              type="submit" 
              disabled={isLoading}
            >
              {isLoading ? <Loader2 className="mr-3 h-5 w-5 animate-spin text-[#F5F2E8]" /> : null}
